...
//Productsテーブルに対するDB操作をまとめてあるクラス
...
public class ProductRepository
{
    ...
    public int Add(string name , int price) {
        ...
        command.Parameters.AddWithValue("$price", price); //SQLインジェクション対策
    ...
    public void Update(Product product) {
        ...
        command.Parameters.AddWithValue("$price", product.Price); //SQLインジェクション対策
